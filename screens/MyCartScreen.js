...
const cartItems = [
    ...
    },
    {
        ...
        image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBij3RTJEsCpNAdfi63FhVE6AURHi4Dn1clbEavKLS9XSI4JqG0dD4zeS8iu-Uale4Z7fpRpgwztD3cipPg6qWGLS8XM4uSibFnIouSH4QKp8t-m9BD-_my1bwQi6sKqG2V64Bj9Jn_kQ64BX3P9-6SF8MTicAKVlVvooQdsVeFz3UMHfb-3ifKZdnBFCh045aH3l2YquiyHQN8QYEQqZCHbFCzb7HCpeyjRIlcVZdAPjI6IrIT93NrHxAzWTCNJSWOkwJnH13jHi4',
    ...
    },
    {
        ...
        image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBmL_Ye-oOl5HrK1iP8yyc7M5bo-Bu1WjAlGKqUbRplJy0QiyeQNqSOkONTnciyUhgtfV-lQqng3fzV2Tq0BTMPDnC0JeHU-wnxJBmMAFU2G9FN3-kjHXtNKglwprMCZLL_z_orhLGeTsz5r-2veE6ScqKvrtXddfTO7Q-Zt-iKr8xlLNT_N0vrobMpqT6B9gmlmebkg-8cAO9cPaJk9IWw434QAwwupeXLbWJmrzpa_vwfaqGFnYD33U9BRF67ixo6wFlrfdlPyyA',
        orderType: 'Bulk Order',
        price: '₹14,000.00',
    }
];
...
const styles = StyleSheet.create({
    ...
    header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 16, backgroundColor: 'rgba(255,255,255,0.8)', zIndex: 10, borderBottomWidth: 1, borderColor: '#f3f4f6' },
